        ...
        <div className="flex flex-col h-full">
          <div className="p-3 sm:p-4 border-b border-gray-100">
            <div className="flex items-center justify-center mb-4 sm:mb-6">
              <img src="/images/output-onlinepngtools.png" alt="Logo" className="h-8 sm:h-10" />
            </div>
          </div>
            ...
            <nav className="space-y-1">
              {isLoading ? (
                ...
                <>
                  ...
                  {/* Units Section */}
                  <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider px-3 mt-5 sm:mt-6 mb-2">الوحدات</h2>
                  {unitsItems.map((item) => (
                    (!item.permission || hasPermission(item.permission)) && (
                        ...
                        {item.isExpandable ? (
                          <>
                            <button
                              ...
                              className={`flex items-center justify-between w-full p-2 sm:p-3 rounded-lg transition-colors ${
          ...
          <div className="p-3 sm:p-4 border-t border-gray-100">
            <button
              ...
              className="flex items-center p-2 sm:p-3 w-full rounded-lg text-red-600 hover:bg-red-50 transition-colors"
            >
